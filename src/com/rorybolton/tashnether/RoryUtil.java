...
public class RoryUtil {
	public void loadConfiguration(Main plugin){
	     plugin.getConfig().addDefault("data.text.netherwarning", "If you use this command there is a low chance that you may spawn in fire as it is still in alpha. Type '/nether y' if you agree to this risk and wont wish harm upon me should you die. - rory838");
	     plugin.getConfig().addDefault("data.world.overworld", "world");
	     plugin.getConfig().addDefault("data.world.netherworld", "world_nether");
	     plugin.getConfig().addDefault("data.world.netherworld", "world_nether");
